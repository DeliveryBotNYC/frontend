...
import Stripe from "../accounts/Stripe";
import PaymentMethods from "../accounts/PaymentMethods";
...
interface RetailAccountBillingProps {
...
const RetailAccountBilling: React.FC<RetailAccountBillingProps> = ({
  accountsData,
  setAccountsData,
}) => {
...
export default RetailAccountBilling;
