const OrderPicked = ({ isCompleted }: { isCompleted: boolean }) => {
  return (
    <div className="relative isolate">
      ...
      <div className="flex items-end justify-between gap-2.5 pt-5">
        ...
        <div className="flex items-center gap-2.5">
          ...
          {/* Text */}
          <p className="text-xs text-themeLightBlack font-bold">
            Order Picked-up
          </p>
        </div>
      ...
      <div className="flex items-end justify-between gap-2.5 pt-5">
        ...
        <div className="flex items-center gap-2.5">
          ...
          {/* Text */}
          <p className="text-xs text-themeDarkGray">Arrived at pickup</p>
        </div>
