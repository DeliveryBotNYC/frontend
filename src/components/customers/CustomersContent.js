...
const CustomersContent = () => {
    ...
    return (_jsx(ContentBox2, { children: _jsx(TableContainer, { searchEnabled: true, downloadEnabled: true, refreshEnabled: true, onSearch: handleSearch, onDownloadCurrent: handleDownloadCurrent, onDownloadAll: handleDownloadAll, onRefresh: handleRefresh, headers: headers, data: data || [], isLoading: isLoading || isRefreshing, error: error, rowComponent: CustomerSingleRow, totalPages: totalPages, initialSortBy: sortBy, initialRowsPerPage: totalValuesPerPage, initialPage: currentActivePage, onPageChange: setCurrentActivePage, onRowsPerPageChange: setTotalValuesPerPage, onSortChange: handleSortChange }) }));
};
